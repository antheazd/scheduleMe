                        ...
                        <div className="table_div">
                            ...
                            <ul>
                                <div>
                                    {appointments.map(i =>
                                        <div key={i.id}>
                                            <Appointment key={i.id} extra_weeks={this.state.extra_weeks} start_hour={i.start_hour} start_minute={i.start_minute} duration={i.duration} alt={i.alt} lng={i.lng} day={i.day} name={i.name} surname={i.surname} price={i.price} kind={i.kind} />
                                        </div>
                                    )}
                                </div>
